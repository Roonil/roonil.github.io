...
class WayVesSearchBar extends StatefulWidget {
  const WayVesSearchBar({
    super.key,
    required this.theme,
  ...
  @override
  State<WayVesSearchBar> createState() => _WayVesSearchBarState();
}

class _WayVesSearchBarState extends State<WayVesSearchBar> {
  ...
  void dispose() {
    ...
    // Crucial: Cancel the timer when the widget is disposed
    _debouncer.dispose();
    super.dispose();
  }
              ...
              child: BlocConsumer<SearchBloc, SearchState>(
                ...
                builder: (context, state) {
                  ...
                  return SearchBar(
                    ...
                    onChanged: (value) => {
                      outerSearchBarFocusNode.unfocus(),
                      // outerTextEditingController.text = "",
                    },
                          ...
                          child: ListTile(
                            ...
                            onTap: () async {
                              ...
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                final context =
                                    headings[searchEntry.route]?[searchHit
                                            .heading]!
                                        .currentContext;
                                if (context != null) {
                            ...
                            title: RichTextFromTicks(
                              text: searchHit.keyword,
                              style: theme.textTheme.titleLarge,
                            ),
                            subtitle: RichTextFromTicks(
