...
class HorizontalTableRow {
  ...
  factory HorizontalTableRow.fromJson(List<String> jsonRow) {
    if (jsonRow.length == 4) {
      return HorizontalTableRow(
        property: jsonRow[0],
...
class HorizontalTable extends StatelessWidget {
  final HorizontalTableRow? tableHeader;
  final List<HorizontalTableRow> tableRows;
      ...
      children: [
        ...
        Padding(
          ...
          child: Table(
            ...
            children: tableRows
                .map(
                  (HorizontalTableRow tableRow) => TableRow(
                    children: [
                      TableCell(
