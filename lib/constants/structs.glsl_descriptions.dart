String chainAudioStructDescription =
    "Represents Audio Settings and captured Audio Data.";
List<String> chainAudioParameters = ["value", "multiplier"];
...
List<String> chainAudioDataTypes = ["vec2", "float"];

List<String> chainAudioExamples = ["-", "100"];

String chainAudioSettingsStructDescription =
...
List<String> chainAudioSettingsDataTypes = ["int", "int", "int", "int"];

List<String> chainAudioSettingsExamples = ["1", "1", "1", "1"];
