...
class LinearExamplesScreen extends StatefulWidget {
  const LinearExamplesScreen({super.key});
  static const routeName = '/shaders/linear/examples';

  @override
  State<LinearExamplesScreen> createState() => _LinearExamplesScreenState();
}

class _LinearExamplesScreenState extends State<LinearExamplesScreen> {
  @override
...
void modifySDFs()
{
            ...
            const Divider(),
            RoundedExpansionTile(
              key: heading["Merged Bars"],
              titleString: "Merged Bars",
              subtitleString:
